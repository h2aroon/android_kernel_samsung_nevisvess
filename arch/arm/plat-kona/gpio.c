...
int __init kona_gpio_init(int num_bank)
{
...
#ifdef	CONFIG_MACH_RHEA_SS_NEVISW
    /*Pin input/output setting for GPIO TEST*/

	/*Input setting*/
	kona_gpio_direction_input(NULL,35);//GPIO35 STAT2

	kona_gpio_direction_input(NULL,51);//GPIO51 CAM_SCL
	kona_gpio_direction_input(NULL,52);//GPIO52 CAM_SDA
    
	kona_gpio_direction_input(NULL,109);//GPIO109 NC
	kona_gpio_direction_input(NULL,121);//GPIO121 NC
	
	/*Output setting*/
	kona_gpio_direction_output(NULL,7,0);//GPIO07 BT_WAKE
	kona_gpio_direction_output(NULL,28,0);//GPIO28 GPS_EN
	kona_gpio_direction_output(NULL,33,0);//GPIO33 CAM_RST
	kona_gpio_direction_output(NULL,56,0);//GPIO56 TOUCH_EN
	kona_gpio_direction_output(NULL,70,0);//GPIO70 WLAN_REG_ON
	kona_gpio_direction_output(NULL,92,0);//GPIO92 BT_RST_N
	
	kona_gpio_direction_output(NULL,97,0);//GPIO97 GPS_CAL_REQ
	kona_gpio_direction_output(NULL,98,0);//GPIO98 TOUCH_EN1
    kona_gpio_direction_output(NULL,100,0);//GPIO100 BT_REG_ON
	
	
	kona_gpio_direction_output(NULL,111,0);//GPIO111 CAM_EN
#endif

#ifdef	CONFIG_MACH_RHEA_SS_NEVISNVESS
    /*Pin input/output setting for GPIO TEST*/
	...
	kona_gpio_direction_output(NULL,28,0);//GPIO28 GPS_EN
	kona_gpio_direction_output(NULL,33,0);//GPIO33 CAM_RST
	kona_gpio_direction_output(NULL,37,1);//GPIO37 NFC_WAKE
	kona_gpio_direction_output(NULL,56,0);//GPIO56 TOUCH_EN
	kona_gpio_direction_output(NULL,70,0);//GPIO70 WLAN_REG_ON
	kona_gpio_direction_output(NULL,87,0);//GPIO87 NFC_EN
        kona_gpio_direction_output(NULL,92,0);//GPIO92 BT_RST_N
        kona_gpio_direction_output(NULL,97,0);//GPIO97 GPS_CAL_REQ
        kona_gpio_direction_output(NULL,98,0);//GPIO98 TOUCH_EN1
        kona_gpio_direction_output(NULL,100,0);//GPIO100 BT_REG_ON
	kona_gpio_direction_output(NULL,111,0);//GPIO111 CAM_EN
	kona_gpio_direction_output(NULL,122,0);//GPIO122 BT_WAKE
#endif

#ifdef	CONFIG_MACH_RHEA_SS_NEVISVESS
    /*Pin input/output setting for GPIO TEST*/
    ...
    kona_gpio_direction_input(NULL,85);//GPIO85 NC
	kona_gpio_direction_input(NULL,86);//GPIO86 NC
	kona_gpio_direction_input(NULL,87);//GPIO87 NC
