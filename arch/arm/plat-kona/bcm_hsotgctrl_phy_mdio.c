...
static int USB_MDIO[6] = {
	0x18,			/* MDIO Register 0 initial value 0x18  */
	0x80,			/* MDIO Register 1 initial value 0x80*/
	0,				/* MDIO Register 2 initial value */
	0x2600,			/* MDIO Register 3 initial value 0x2600*/
	0x0020,			/* MDIO Register 4 initial value  0x0100 */
	0				/* MDIO Register 5 initial value */
};
