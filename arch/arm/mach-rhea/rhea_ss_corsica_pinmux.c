...
//	PIN_CFG(TRACEDT03, PTI_DAT3, 0, OFF, ON, 0, 0, 8MA),	// N.C
	...
	PIN_CFG(DSI0TE, GPIO37, 0, OFF, OFF, 0, 0, 8MA), 	// NC
...
*/
	...
	/* TOUCH */
	PIN_CFG(SIMDET, GPIO56, 0, OFF, OFF, 0, 0, 8MA),    // TOUCH_EN
	PIN_CFG(GPS_TMARK, GPIO98, 0, OFF, OFF, 0, 0, 8MA), // TOUCH_EN1
...
//@HW LCD part configuration
	...
	PIN_CFG(CAMCS0, LCDD16, 0, OFF, ON,  0, 0, 8MA), // LCD_D16
	PIN_CFG(CAMCS1, LCDD17, 0, OFF, ON,  0, 0, 8MA), // LCD_D17
	...
	PIN_CFG(ICUSBDP, GPIO121, 0, OFF, OFF, 0, 0, 8MA), // LCD_DET
