...
//@HW
	...
	/*	Pinmux for keypad */
	PIN_CFG(GPIO07, KEY_R7, 0, ON, OFF, 0, 1, 8MA),
...
//	PIN_CFG(TRACEDT03, PTI_DAT3, 0, OFF, ON, 0, 0, 8MA),	// N.C
	...
	PIN_CFG(ICUSBDM, GPIO122, 0, ON, OFF, 0, 0, 8MA),		// BT_WAKE
...
//	PIN_CFG(GPIO21, UB2CTSN, 0, OFF, ON, 0, 0, 8MA),	// UB2_BT_UART_CTS_N
	...
	/* NFC */
	PIN_CFG(SSPCK, GPIO87, 0, ON, OFF, 0, 1, 8MA),		// NFC_EN  (pin,f,hys,pdn,pup,src,ind,dsc)
	PIN_CFG(SSPSYN, GPIO85, 0, OFF, OFF, 0, 0, 8MA),	// NFC_SDA
	PIN_CFG(SSPDO, GPIO86, 0, OFF, OFF, 0, 0, 8MA),		// NFC_SCL
	PIN_CFG(GPS_CALREQ, GPIO99, 0, ON, OFF, 0, 0, 8MA),	// NFC_IRQ
	PIN_CFG(DSI0TE, GPIO37, 0, OFF, OFF, 0, 1, 8MA),	// NFC_WAKE
	PIN_CFG(GPIO05, ANA_SYS_REQ1, 0, ON, OFF, 0, 0, 8MA),   // NFC CLK REQ Not Used
