...
static int s2200_ts_power(int on_off)
{
	...
	pr_info("%s: NEVISNVESS TS power change to %d.\n", __func__, on_off);
...
#include "board-rhea_ss_nevisnvess-wifi.h"
...
static struct bcm_keymap newKeymap[] = {
	...
	{BCM_KEY_ROW_7, BCM_KEY_COL_4, "Volume Up", KEY_VOLUMEUP},
	{BCM_KEY_ROW_7, BCM_KEY_COL_5, "Home-Key", KEY_HOME},
...
#define BCMBT_NFC_CLK_REQ_GPIO	(05)       //NFC_CLK_REQ
#define BCMBT_NFC_WAKE_GPIO	(37)       //NFC_WAKE
...
#if defined(CONFIG_STEREO_SPEAKER)// NEVISNVESS_AMP
...
#ifdef CONFIG_BCM_BZHW
#define GPIO_BT_WAKE 122	/*BT_WAKE*/
...
MACHINE_START(RHEA, "rhea_ss_nevisnvess")
	.map_io = board_map_io,
