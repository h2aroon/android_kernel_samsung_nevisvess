...
#endif
/* USB OVP(USBOV_TH_SEL)=6.5V */
	{.map = 0, .addr = 0x11, .val = 0x3C, .mask = 0xFF},
	...
	*/
	...
	/* nevisnvess 00; VDD_GPS_2.8V always on*/
...
static struct bcmpmu_voltcap_map batt_voltcap_map[] = {
	/**
	* OCV_1300mAh AVG BYD, SDI, Elentech 7.8. 2013
	*/
	{4167, 100},
	{4115, 95 },
	{4072, 90 },
...
static struct bcmpmu_fg_zone fg_zone[FG_TMP_ZONE_MAX+1] = {
	...
	*/
	...
	.esr_vl_lvl= 3341, .esr_vl_slope= -2949	, .esr_vl_offset= 11664,
	.esr_vm_lvl= 3421, .esr_vm_slope= 460 	, .esr_vm_offset= 274  ,
	.esr_vh_lvl= 3611, .esr_vh_slope= -371	, .esr_vh_offset= 3117 ,
	.esr_vf_lvl= 4167, .esr_vf_slope= -2310	, .esr_vf_offset= 10118,
	.vcmap = &batt_voltcap_map[0],
	.maplen = ARRAY_SIZE(batt_voltcap_map)},

	{ .temp = -150,
	.reset=0,.fct =  565,.guardband = 50,
	.esr_vl_lvl= 3517, .esr_vl_slope=  -2948, .esr_vl_offset= 11394,
	.esr_vm_lvl= 3889, .esr_vm_slope=  -410	, .esr_vm_offset= 2467 ,
	.esr_vh_lvl= 3999, .esr_vh_slope=  -2066, .esr_vh_offset= 8907 ,
	.esr_vf_lvl= 4167, .esr_vf_slope=  -2066, .esr_vf_offset= 8907 ,
	.vcmap = &batt_voltcap_map[0],
	.maplen = ARRAY_SIZE(batt_voltcap_map)},


	{ .temp = -100,
	.reset=0,.fct =  757,.guardband = 50,
	.esr_vl_lvl= 3517, .esr_vl_slope= -2948 , .esr_vl_offset= 11394,
	.esr_vm_lvl= 3889, .esr_vm_slope= -410	, .esr_vm_offset= 2467 ,
	.esr_vh_lvl= 3999, .esr_vh_slope= -2066 , .esr_vh_offset= 8907 ,
	.esr_vf_lvl= 4167, .esr_vf_slope= -2066 , .esr_vf_offset= 8907 ,
	...
	{ .temp = -50,
	.reset=0,.fct =  835,.guardband = 30,
	.esr_vl_lvl= 3502, .esr_vl_slope= -2811	, .esr_vl_offset= 10628,
	.esr_vm_lvl= 3674, .esr_vm_slope= -1483	, .esr_vm_offset= 5977 ,
	.esr_vh_lvl= 3738, .esr_vh_slope= 1568	, .esr_vh_offset= -5234,
	.esr_vf_lvl= 4167, .esr_vf_slope= -859	, .esr_vf_offset= 3839 ,
	.vcmap = &batt_voltcap_map[0],
	.maplen = ARRAY_SIZE(batt_voltcap_map)},

	{ .temp = 0,
	.reset=0,.fct =  913,.guardband = 30,
	.esr_vl_lvl= 3502, .esr_vl_slope= -2811	, .esr_vl_offset= 10628,
	.esr_vm_lvl= 3674, .esr_vm_slope= -1483	, .esr_vm_offset= 5977 ,
	.esr_vh_lvl= 3738, .esr_vh_slope= 1568	, .esr_vh_offset= -5234,
	.esr_vf_lvl= 4167, .esr_vf_slope= -859	, .esr_vf_offset= 3839 ,
	...
	.esr_vl_lvl= 3537, .esr_vl_slope= -2125	, .esr_vl_offset= 8033 ,
	.esr_vm_lvl= 3708, .esr_vm_slope= -1066	, .esr_vm_offset= 4287 ,
	.esr_vh_lvl= 3791, .esr_vh_slope= 1112	, .esr_vh_offset= -3790,
	.esr_vf_lvl= 4167, .esr_vf_slope= -743	, .esr_vf_offset= 3242 ,
	.vcmap = &batt_voltcap_map[0],
	.maplen = ARRAY_SIZE(batt_voltcap_map)},
	...
	{ .temp = 150,
	.reset=0,.fct =  987,.guardband = 30,
	.esr_vl_lvl= 3637, .esr_vl_slope= -1567	, .esr_vl_offset= 5963 ,
	.esr_vm_lvl= 3753, .esr_vm_slope= -323	, .esr_vm_offset= 1438 ,
	.esr_vh_lvl= 3794, .esr_vh_slope= 1402	, .esr_vh_offset= -5035,
	.esr_vf_lvl= 4167, .esr_vf_slope= -504	, .esr_vf_offset= 2197 ,
	.vcmap = &batt_voltcap_map[0],
	.maplen = ARRAY_SIZE(batt_voltcap_map)},
...
static struct bcmpmu_platform_data bcmpmu_plat_data = {
	...
	.fg_smpl_rate = 2083,
	.fg_slp_rate = 32000,
	.fg_slp_curr_ua = 1436, // NevisNVESS R02
	.fg_factor = 820,       // NevisNVESS R02 NFC
	.fg_sns_res = 10,
	...
	.cutoff_volt = 3510,  /* 0% capacity checking */
	.cutoff_count_max = 3,
	.hard_reset_en = -1,
	.restart_en = -1,
	.pok_hold_deb = -1,
