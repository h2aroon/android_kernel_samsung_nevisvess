...
static int s2200_ts_power(int on_off)
{
	...
	pr_info("%s: Nevisw TS power change to %d.\n", __func__, on_off);
...
#include "board-rhea_ss_nevisw-wifi.h"
...
#if defined(CONFIG_STEREO_SPEAKER)// NEVISW_AMP
...
MACHINE_START(RHEA, "rhea_ss_nevisw")
	.map_io = board_map_io,
