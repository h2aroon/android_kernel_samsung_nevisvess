...
static int sco_connect(struct sock *sk, __s8 is_wbs)
{
	...
	struct hci_dev  *hdev;
	int err, type;
	char *dell_bh200_bdaddr_capital_letters = "1C:65:9D";	// BDADDR of Dell BH200 - Capital Letters
	char *dell_bh200_bdaddr_small_letters = "1c:65:9d";	// BDADDR of Dell BH200 - Small Letters
	...
	if (lmp_esco_capable(hdev) && !disable_esco) {
		/*Disable eSCO for Dell BH200 headset*/
		if(!((strncmp(batostr(dst), dell_bh200_bdaddr_small_letters, 8)) && (strncmp(batostr(dst), dell_bh200_bdaddr_capital_letters, 8)))){
		     type = SCO_LINK;
