...
#if defined(CONFIG_MACH_RHEA_SS_IVORY) || defined(CONFIG_MACH_RHEA_SS_NEVIS) || defined(CONFIG_MACH_RHEA_SS_NEVISP) || defined(CONFIG_MACH_RHEA_SS_CORSICA) || defined(CONFIG_MACH_RHEA_SS_NEVISDS) || defined(CONFIG_MACH_RHEA_SS_NEVISW) || defined(CONFIG_MACH_RHEA_SS_NEVISNVESS)|| defined(CONFIG_MACH_RHEA_SS_NEVISVESS)
/* DLG IOCTL interface */
