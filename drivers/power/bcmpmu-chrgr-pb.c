...
#if defined(CONFIG_MACH_RHEA_SS_CORIPLUS) || defined(CONFIG_MACH_RHEA_SS_ZANIN)|| defined(CONFIG_MACH_RHEA_SS_CORSICA) || defined(CONFIG_MACH_RHEA_SS_CORSICASS)||defined(CONFIG_MACH_RHEA_SS_NEVISW) || defined(CONFIG_MACH_RHEA_SS_NEVISNVESS) || defined(CONFIG_MACH_RHEA_SS_NEVISVESS)
