...
CSL_SMI_TIMIMG_T rdTiming_ili9486_smi = { 0, 90, 10, 360 };	///<  RD timing
CSL_SMI_TIMIMG_T wrTiming_r_ili9486_smi= { 16,  30, 10, 30 };	///<  REG WR timing
CSL_SMI_TIMIMG_T wrTiming_m_ili9486_smi = { 10,  12, 10, 30 };	///<  MEM WR timing


DISPCTRL_REC_T power_on_seq_ili9486_smi[] =
{
	{DISPCTRL_SLEEP_MS, 0, 100},   /* delay after Reset 100 + 100 = 200 */

    /* + Power Setting Sequence */
    {DISPCTRL_WR_CMND, 0xC0, 0}, 
	{DISPCTRL_WR_DATA, 0, 0x0B},	/* Changed for Nevis W */
	{DISPCTRL_WR_DATA, 0, 0x0B},	/* Changed for Nevis W */
	...
	{DISPCTRL_WR_DATA, 0, 0x12},	/* Changed for Nevis W */
	...
	{DISPCTRL_WR_CMND, 0x44, 0}, /* Changed for Nevis W */
	{DISPCTRL_WR_DATA, 0, 0x01},	
	...
	{DISPCTRL_WR_DATA, 0, 0x0F},	/* Changed for Nevis W */
	{DISPCTRL_WR_DATA, 0, 0x18},	
...
DISPCTRL_REC_T power_off_seq_ili9486_smi[] =
{
...
DISPCTRL_REC_T sleep_in_seq_ili9486_smi[] =
{
	{DISPCTRL_WR_CMND, 0x28,0},  
...
DISPCTRL_REC_T sleep_out_seq_ili9486_smi[] =
{
	{DISPCTRL_WR_CMND, 0x11,0},
	{DISPCTRL_SLEEP_MS, 0, 120},
	/* + Block Write*/
...
DISPCTRL_REC_T display_on_seq_ili9486_smi[] =
{
	{DISPCTRL_WR_CMND, 0x29,0},
	{DISPCTRL_SLEEP_MS, 0, 20},
    {DISPCTRL_LIST_END, 0, 0}
...
DISPCTRL_REC_T display_off_seq_ili9486_smi[] =
{
	{DISPCTRL_WR_CMND, 0x28,0},
