...
#define USE_CID_CHECK
	...
	|| defined (CONFIG_MACH_CAPRI_SS_CRATER) || defined(CONFIG_MACH_RHEA_SS_IVORYSS) || defined(CONFIG_MACH_RHEA_SS_NEVISDS) || defined (CONFIG_MACH_RHEA_SS_CORSICA) || defined (CONFIG_MACH_RHEA_SS_CORSICASS)|| defined (CONFIG_MACH_RHEA_SS_NEVISW) || defined (CONFIG_MACH_RHEA_SS_NEVISNVESS)|| defined (CONFIG_MACH_RHEA_SS_NEVISVESS)
#define BCMHOST_XTAL_PU_TIME_MOD
#define READ_MACADDR
#undef HW_OOB
#undef USE_CID_CHECK
