...
#define ACCESSORY_INSERTION_SETTLE_TIME 	msecs_to_jiffies(100)//weichang.dong reduce debounce time for Earjack detect time too long issue (from insert ep to spk output off)
...
#if defined (CONFIG_MACH_RHEA_SS_CORSICA) || defined (CONFIG_MACH_RHEA_SS_CORSICASS) || defined (CONFIG_MACH_RHEA_SS_IVORY)|| defined (CONFIG_MACH_RHEA_SS_NEVISW) || defined (CONFIG_MACH_RHEA_SS_NEVISNVESS) || defined (CONFIG_MACH_RHEA_SS_NEVISVESS)
...
#if !(defined(CONFIG_MACH_RHEA_SS_NEVISP) || defined(CONFIG_MACH_RHEA_SS_NEVIS) || defined(CONFIG_MACH_RHEA_SS_NEVISDS)|| defined(CONFIG_MACH_RHEA_SS_CORSICA) ||defined(CONFIG_MACH_RHEA_SS_CORSICA_REV02))|| defined (CONFIG_MACH_RHEA_SS_NEVISW)  || defined (CONFIG_MACH_RHEA_SS_NEVISNVESS)|| defined (CONFIG_MACH_RHEA_SS_NEVISVESS)
		do{
			config_adc_for_accessory_detection(hst);
