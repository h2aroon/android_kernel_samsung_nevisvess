...
#if defined (CONFIG_RMI4_FW_CORSICA) || defined (CONFIG_RMI4_FW_CORSICASS) || defined (CONFIG_RMI4_FW_NEVISW)  || defined (CONFIG_RMI4_FW_NEVISNVESS)|| defined (CONFIG_RMI4_FW_NEVISVESS)
